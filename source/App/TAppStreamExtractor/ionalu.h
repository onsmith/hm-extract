...
protected:
  ...
  // Number of leading zero bytes before the nal unit starts
  int numLeadingZeroBytes;

  // Number of trailing zero bytes after the nal unit
  int numTrailingZeroBytes;
...
private:
  void readHeader(ibitstream& data);
};
